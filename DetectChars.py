...
def checkIfPossibleChar(possibleChar):
    ...
    if (possibleChar.intBoundingRectArea > MIN_PIXEL_AREA and
        ...
        #print '\n the dims ',  possibleChar.intBoundingRectArea, possibleChar.intBoundingRectWidth, possibleChar.intBoundingRectHeight,possibleChar.fltAspectRatio
        return True
    else:
        return False
    # end if
...
def findListOfMatchingChars(possibleChar, listOfChars):
    ...
    for possibleMatchingChar in listOfChars:                # for each char in big list
        ...
        #print "O",fltDistanceBetweenChars,possibleChar.fltDiagonalSize * MAX_DIAG_SIZE_MULTIPLE_AWAY,fltAngleBetweenChars,fltChangeInArea,fltChangeInWidth,fltChangeInHeight
        if (fltDistanceBetweenChars < (possibleChar.fltDiagonalSize * MAX_DIAG_SIZE_MULTIPLE_AWAY) and
            fltAngleBetweenChars < MAX_ANGLE_BETWEEN_CHARS and
            fltChangeInArea < MAX_CHANGE_IN_AREA and
            fltChangeInWidth < MAX_CHANGE_IN_WIDTH and
            fltChangeInHeight < MAX_CHANGE_IN_HEIGHT):
            #print "T",fltDistanceBetweenChars,possibleChar.fltDiagonalSize * MAX_DIAG_SIZE_MULTIPLE_AWAY,fltAngleBetweenChars,fltChangeInArea,fltChangeInWidth,fltChangeInHeight
